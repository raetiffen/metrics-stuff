...
Ridge:
* [Ridge regression algorithm which appends sqrt(lambda)*I to the bottom of X and solves with modified Gram-Schmidt](</Ridge algorithms/ridge mgs.py>)
...
* [Panel data lecture slides](<Misc/panel data slides.pdf>)
